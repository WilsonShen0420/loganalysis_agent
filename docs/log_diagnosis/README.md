...
roslaunch loganalysis_agent logdiag.launch llm_backend:=cloud
...
| 參數 | 預設值 | 說明 |
|------|--------|------|
| `logdiag/llm_backend` | `cloud` | LLM 後端: `cloud` 或 `local` |
| `logdiag/cloud/model` | `claude-sonnet-4-20250514` | 雲端模型 |
